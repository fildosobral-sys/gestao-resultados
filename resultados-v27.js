(() => {
  ...
  function applyV56TabletPolish() {
    ...
    st.textContent = `
      ...
      /* V70 — composição horizontal de serviços no dashboard da filial */
      .branch-composition-wrap{grid-template-columns:150px minmax(220px,.7fr) minmax(320px,1.5fr)!important;align-items:center!important;gap:24px!important}
      .dashboard-composition-bars{display:grid;gap:14px;min-width:0;padding:4px 0}
      .dashboard-composition-bar{min-width:0}
      .dashboard-composition-bar-head{display:flex;justify-content:space-between;align-items:baseline;gap:14px;margin-bottom:7px;color:#53677b;font-size:.78rem;font-weight:800}
      .dashboard-composition-bar-head strong{color:#17324d;font-size:.8rem;white-space:nowrap}
      ...
      @media (max-width:900px){.branch-composition-wrap{grid-template-columns:130px minmax(0,1fr)!important;gap:18px!important}.branch-composition-wrap .dashboard-composition-bars{grid-column:1/-1}}
      @media (max-width:560px){.branch-composition-wrap{grid-template-columns:110px minmax(0,1fr)!important;gap:14px!important}.dashboard-composition-bar-head{font-size:.72rem;gap:8px}.dashboard-composition-bar-head strong{font-size:.72rem}.dashboard-composition-track{height:11px}}
