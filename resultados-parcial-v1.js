(() => {
  ...
  const MAIN_STORE = 'fs_gestao_resultados_v1';
  ...
  function loadMain(){ try { return JSON.parse(localStorage.getItem(MAIN_STORE) || '{}') || {}; } catch { return {}; } }
  ...
  function goalForSeller(s, kind){
    ...
    return Number(s.assignedServiceGoal || s.servicesGoal || s.goalServices || 0) || (all.length ? base.services/all.length : 0);
  }
